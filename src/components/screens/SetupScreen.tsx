...
export default function SetupScreen({ mode, onBack, onStart }: SetupScreenProps) {
  ...
  return (
    <div className="screen">
      ...
      {isRemote && (
        <div style={{ fontFamily: 'var(--font-m)', fontSize: 13, color: 'var(--ink-muted)', lineHeight: 1.6 }}>
          Participants join by scanning your room code on their own devices. No need to enter names here.
        </div>
      )}
